...
export default function LoginPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      sessionStorage.removeItem('caas_password');
...
const s = {
  ...
  card: { background: 'white', borderRadius: 24, padding: '40px 36px', width: '100%', maxWidth: 420, boxShadow: '0 8px 40px rgba(0,0,0,.1),0 2px 8px rgba(200,39,45,.08)', position: 'relative' },
